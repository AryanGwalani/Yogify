...
public class CameraSourcePreview extends ViewGroup {
  ...
  private com.example.miniproject_yogify.CameraSource cameraSource;
  ...
  private void start(com.example.miniproject_yogify.CameraSource cameraSource) throws IOException {
  ...
  public void start(com.example.miniproject_yogify.CameraSource cameraSource, GraphicOverlay overlay) throws IOException {
  ...
  private void startIfReady() throws IOException, SecurityException {
    if (startRequested && surfaceAvailable) {
      ...
      if (overlay != null) {
        ...
        boolean isImageFlipped = cameraSource.getCameraFacing() == com.example.miniproject_yogify.CameraSource.CAMERA_FACING_FRONT;
        if (isPortraitMode()) {
